...
public class JuegoJpaController implements Serializable {
    ...
    public JuegoJpaController(){
        emf = Persistence.createEntityManagerFactory("trabajoFinalPU");
    }
    ...
    public void decrementarCantidad(int id) {
        try{    
        Juego jue = this.findJuego(id);
        jue.setCapacidad(jue.getCapacidad()-1);
